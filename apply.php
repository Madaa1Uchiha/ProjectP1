<!--
  This page allows applicants to submit their details for job applications.
  It collects information such as job reference, personal details, skills,
  contact information, location, and additional relevant information.
-->
...
<main>
  <form method="post" action="process_eoi.php">
    ...
    <fieldset>
      ...
      <label for="skills1">Skill 1</label>
      <textarea name="skills1" id="skills1"></textarea>
      <label for="skills2">Skill 2</label>
      <textarea name="skills2" id="skills2"></textarea>
      <label for="skills3">Skill 3</label>
